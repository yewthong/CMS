...
/**
 * Servlet implementation class ADVDepartureSchedule
 */
@WebServlet("/ADVDepartureSchedule")
public class ADVDepartureSchedule extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ADVDepartureSchedule() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try(PrintWriter out = response.getWriter()){
			...
			out.println("<h2>View Departure Sailing Schedule</h2>");
